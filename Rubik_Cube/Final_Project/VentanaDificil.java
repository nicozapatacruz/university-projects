...
public class VentanaDificil extends JFrame implements ActionListener 
{
   //CARA IZQUIERDA
   public JButton Uno;
   public JButton Dos;
   ...
   public VentanaDificil(){
       ...
       JLabel Facil = new JLabel("DIFICIL");
      ...
      for (int i = 0, k = 0; i < 3; i++, k += 45){
       ...
       IZQ[0][0].setBackground(Color.green);
       IZQ[0][1].setBackground(Color.yellow);
       IZQ[0][2].setBackground(Color.yellow);
       IZQ[1][0].setBackground(Color.orange);
       IZQ[1][1].setBackground(Color.white);
       IZQ[1][2].setBackground(Color.red);
       IZQ[2][0].setBackground(Color.green);
       IZQ[2][1].setBackground(Color.white);
       IZQ[2][2].setBackground(Color.white);
      ...
      for (int i = 0, k = 0; i < 3; i++, k += 45){
       ...
       FRO[0][0].setBackground(Color.red);
       FRO[0][1].setBackground(Color.yellow);
       FRO[0][2].setBackground(Color.yellow);
       FRO[1][0].setBackground(Color.white);
       FRO[1][1].setBackground(Color.orange);
       FRO[1][2].setBackground(Color.green);
       FRO[2][0].setBackground(Color.orange);
       FRO[2][1].setBackground(Color.yellow);
       FRO[2][2].setBackground(Color.green);
      ...
      //CARA DERECHA
       ...
       DER[0][0].setBackground(Color.blue);
       DER[0][1].setBackground(Color.red);
       DER[0][2].setBackground(Color.blue);
       DER[1][0].setBackground(Color.white);
       DER[1][1].setBackground(Color.yellow);
       DER[1][2].setBackground(Color.yellow);
       DER[2][0].setBackground(Color.white);
       DER[2][1].setBackground(Color.orange);
       DER[2][2].setBackground(Color.yellow);
      ...
      //CARA TRASERA
       ...
       TRA[0][0].setBackground(Color.white);
       TRA[0][1].setBackground(Color.green);
       TRA[0][2].setBackground(Color.orange);
       TRA[1][0].setBackground(Color.blue);
       TRA[1][1].setBackground(Color.red);
       TRA[1][2].setBackground(Color.green);
       TRA[2][0].setBackground(Color.blue);
       TRA[2][1].setBackground(Color.blue);
       TRA[2][2].setBackground(Color.orange);
      ...
      //CARA ARRIBA
       ...
       ARR[0][0].setBackground(Color.white);
       ARR[0][1].setBackground(Color.red);
       ARR[0][2].setBackground(Color.red);
       ARR[1][0].setBackground(Color.green);
       ARR[1][1].setBackground(Color.green);
       ARR[1][2].setBackground(Color.blue);
       ARR[2][0].setBackground(Color.green);
       ARR[2][1].setBackground(Color.red);
      ...
      //CARA ABAJO
       ...
       ABA[0][0].setBackground(Color.blue);
       ABA[0][1].setBackground(Color.orange);
       ABA[0][2].setBackground(Color.red);
       ABA[1][0].setBackground(Color.blue);
       ABA[1][1].setBackground(Color.blue);
       ABA[1][2].setBackground(Color.white);
       ABA[2][0].setBackground(Color.yellow);
       ABA[2][1].setBackground(Color.orange);
