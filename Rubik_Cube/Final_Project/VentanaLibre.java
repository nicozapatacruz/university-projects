...
public class VentanaLibre extends JFrame implements ActionListener 
{
   //CARA IZQUIERDA
   public JButton Uno;
   public JButton Dos;
   ...
   public VentanaLibre(){
      ...
      for (int i = 0, k = 0; i < 3; i++, k += 45){
       ...
       IZQ[1][0].setBackground(Color.blue);
       IZQ[1][1].setBackground(Color.blue);
       IZQ[1][2].setBackground(Color.blue);
      ...
      for (int i = 0, k = 0; i < 3; i++, k += 45){
       ...
       FRO[0][1].setBackground(Color.orange);
       FRO[0][2].setBackground(Color.orange);
       FRO[1][0].setBackground(Color.orange);
       FRO[1][1].setBackground(Color.orange);
       FRO[1][2].setBackground(Color.orange);
       FRO[2][0].setBackground(Color.orange);
       FRO[2][1].setBackground(Color.orange);
      ...
      //CARA DERECHA
       ...
       DER[1][0].setBackground(Color.green);
       DER[1][1].setBackground(Color.green);
       DER[1][2].setBackground(Color.green);
      ...
      //CARA TRASERA
       ...
       TRA[0][1].setBackground(Color.red);
       TRA[0][2].setBackground(Color.red);
       TRA[1][0].setBackground(Color.red);
       TRA[1][1].setBackground(Color.red);
       TRA[1][2].setBackground(Color.red);
       TRA[2][0].setBackground(Color.red);
       TRA[2][1].setBackground(Color.red);
