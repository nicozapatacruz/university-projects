...
public class VentanaFacil extends JFrame implements ActionListener 
{
   //CARA IZQUIERDA
   public JButton Uno;
   public JButton Dos;
   ...
   public VentanaFacil(){
       ...
       setResizable(false);
       JLabel Facil = new JLabel("FACIL");
       Facil.setBounds(320,20,100,50);
      ...
      for (int i = 0, k = 0; i < 3; i++, k += 45){
       ...
       FRO[0][0].setBackground(Color.orange);
       FRO[0][1].setBackground(Color.white);
       FRO[0][2].setBackground(Color.orange);
       FRO[1][0].setBackground(Color.green);
       FRO[1][1].setBackground(Color.green);
       FRO[1][2].setBackground(Color.green);
       FRO[2][0].setBackground(Color.orange);
       FRO[2][1].setBackground(Color.white);
       FRO[2][2].setBackground(Color.orange);
      ...
      //CARA DERECHA
       ...
       DER[0][1].setBackground(Color.green);
       DER[0][2].setBackground(Color.green);
       DER[1][0].setBackground(Color.red);
       DER[1][1].setBackground(Color.yellow);
       DER[1][2].setBackground(Color.red);
       DER[2][0].setBackground(Color.green);
       DER[2][1].setBackground(Color.green);
      ...
      //CARA TRASERA
       ...
       TRA[0][0].setBackground(Color.red);
       TRA[0][1].setBackground(Color.yellow);
       TRA[0][2].setBackground(Color.red);
       TRA[1][0].setBackground(Color.blue);
       TRA[1][1].setBackground(Color.blue);
       TRA[1][2].setBackground(Color.blue);
       TRA[2][0].setBackground(Color.red);
       TRA[2][1].setBackground(Color.yellow);
       TRA[2][2].setBackground(Color.red);
      ...
      //CARA ARRIBA
       ...
       ARR[0][2].setBackground(Color.white);
       ARR[1][0].setBackground(Color.white);
       ARR[1][1].setBackground(Color.red);
       ARR[1][2].setBackground(Color.white);
       ARR[2][0].setBackground(Color.white);
       ARR[2][1].setBackground(Color.red);
       ARR[2][2].setBackground(Color.white);
      ...
      //CARA ABAJO
       ...
       ABA[0][0].setBackground(Color.yellow);
       ABA[0][1].setBackground(Color.orange);
       ABA[0][2].setBackground(Color.yellow);
       ABA[1][0].setBackground(Color.yellow);
       ABA[1][1].setBackground(Color.orange);
       ABA[1][2].setBackground(Color.yellow);
       ABA[2][0].setBackground(Color.yellow);
       ABA[2][1].setBackground(Color.orange);
       ABA[2][2].setBackground(Color.yellow);
